...
import (
	...
	devgrpc "github.com/basvanbeek/opencensus-gokit-example/frontend/transport/clients/device/grpc"
	devhttp "github.com/basvanbeek/opencensus-gokit-example/frontend/transport/clients/device/http"
)
